/********************************************************************************
** Form generated from reading UI file 'configManual.ui'
**
...
#ifndef UI_CONFIGMANUAL_H
#define UI_CONFIGMANUAL_H
...
public:
    ...
    void setupUi(QDialog *configManual)
    {
        ...
        forward->setValue(50);
        forward->setOrientation(Qt::Horizontal);
        ...
        high->setValue(50);
        high->setOrientation(Qt::Horizontal);
